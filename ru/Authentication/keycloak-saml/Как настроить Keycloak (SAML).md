...
1. Заполните форму **Configure Keycloak Account** (настройка учетной записи Keycloak). Для получения дополнительной информации по заполнению формы см. раздел [Справка по конфигурированию](https://github.com/markizz01/test/blob/main/ru/keycloak-saml/Как%20настроить%20Keycloak%20(SAML).md#справка-по-конфигурированию-1)
