...
- [Архитектура сервера Rancher](https://github.com/rancher/docs/blob/master/content/rancher/v2.6/en/overview/architecture/_index.md "https://github.com/rancher/docs/blob/master/content/rancher/v2.6/en/overview/architecture/_index.md#rancher-server-architecture")
- [Связь с нижестоящими пользовательскими кластерами](https://github.com/rancher/docs/blob/master/content/rancher/v2.6/en/overview/architecture/_index.md "https://github.com/rancher/docs/blob/master/content/rancher/v2.6/en/overview/architecture/_index.md#communicating-with-downstream-user-clusters")
- [Прокси-сервер аутентификации](https://github.com/rancher/docs/blob/master/content/rancher/v2.6/en/overview/architecture/_index.md "https://github.com/rancher/docs/blob/master/content/rancher/v2.6/en/overview/architecture/_index.md#1-the-authentication-proxy")
- [Контроллеры кластера и агенты кластера](https://github.com/rancher/docs/blob/master/content/rancher/v2.6/en/overview/architecture/_index.md "https://github.com/rancher/docs/blob/master/content/rancher/v2.6/en/overview/architecture/_index.md#2-cluster-controllers-and-cluster-agents")
- [N](https://github.com/rancher/docs/blob/master/content/rancher/v2.6/en/overview/architecture/_index.md "https://github.com/rancher/docs/blob/master/content/rancher/v2.6/en/overview/architecture/_index.md#3-node-agents")ode agents
- [Авторизованная конечная точка кластера (ACE)](https://github.com/rancher/docs/blob/master/content/rancher/v2.6/en/overview/architecture/_index.md "https://github.com/rancher/docs/blob/master/content/rancher/v2.6/en/overview/architecture/_index.md#4-authorized-cluster-endpoint-ace")
- [Важные файлы](https://github.com/rancher/docs/blob/master/content/rancher/v2.6/en/overview/architecture/_index.md "https://github.com/rancher/docs/blob/master/content/rancher/v2.6/en/overview/architecture/_index.md#important-files")
- [Инструменты для подготовки кластеров Kubernetes](https://github.com/rancher/docs/blob/master/content/rancher/v2.6/en/overview/architecture/_index.md "https://github.com/rancher/docs/blob/master/content/rancher/v2.6/en/overview/architecture/_index.md#tools-for-provisioning-kubernetes-clusters")
- [Компоненты сервера Rancher и исходный код](https://github.com/rancher/docs/blob/master/content/rancher/v2.6/en/overview/architecture/_index.md "https://github.com/rancher/docs/blob/master/content/rancher/v2.6/en/overview/architecture/_index.md#rancher-server-components-and-source-code")
...
**2. Кластерные контроллеры и кластерные агенты**
...
**4. Авторизованная конечная точка кластера (ACE)**
